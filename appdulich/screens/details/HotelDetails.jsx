...
const HotelDetails = ({navigation}) => {
  ...
  useEffect(() => {
    axios.get(`https://67e017447635238f9aac7da4.mockapi.io/api/v1/hotels/${id}`)
      .then((response) => {
        // console.log("Dữ liệu API nhận được:", response.data); // Debug
        setHotel(response.data); // BỎ `[0]`
        setLoading(false);
      })
      .catch((error) => {
  ...
  return (
    ...
    {/* <ReusableText
      ...
      <View style={[rowWithSpace('space-between'), styles.bottom]}>
          ...
          <ReusableBtn
          onPress={() => navigation.navigate("SelectRoom", {hotelId: hotel.id})}
          btnText={"Chọn phòng"}
